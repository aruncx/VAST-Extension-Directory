    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-2 sm:gap-4">
      {contacts.map((contact) => (
        <button
          ...
          className="text-left bg-white/60 dark:bg-slate-900/50 backdrop-blur-xl border border-white/50 dark:border-slate-700/50 rounded-2xl p-3 sm:p-4 shadow-xl hover:shadow-2xl hover:bg-white/70 dark:hover:bg-slate-900/70 hover:-translate-y-1 transition-all group flex flex-col justify-between h-full focus:outline-none focus:ring-2 focus:ring-primary"
        >
          <div>
